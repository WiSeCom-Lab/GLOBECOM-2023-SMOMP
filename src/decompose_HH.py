...
# Loop
recompute = False                                                               # Force recomputing existing results
for method in ["MOMP", "SMOMP"]:
    cases = {
        "MOMP": [
            (4, 8, 4, 8, 64, -20),
            (4, 8, 4, 8, 64, -10),
    ...
    for N_UE, N_AP, N_M_UE, N_M_AP, Q, p_t_dBm in cases:
        # Params
        verbatim = False        # Extra prints
        set = "office-walls"    # Dataset name
        ...
        if not recompute and exists(
            "data/{}/HH/paths/{}_{}_{}_{}_{}_{}_{}_{}.json".format(
                set, method, N_UE, N_AP, N_M_UE, N_M_AP, Q, p_t_dBm, int(10*K_res))):
            continue
